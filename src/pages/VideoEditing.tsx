...
const SECTIONS = ['Commercial Ads', 'YouTube Content', 'Short-form Content'];

export default function VideoEditing({ openOrderModal }: PageProps) {
  const { products } = useProducts();
  const [isAddModalOpen, setIsAddModalOpen] = useState(false);

  const pageProducts = products.filter(p => p.category === 'video-editing');
